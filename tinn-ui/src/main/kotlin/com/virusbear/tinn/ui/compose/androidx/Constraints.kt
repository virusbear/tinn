...
package com.virusbear.tinn.ui.compose.androidx
 ...
 */
@Stable
fun Constraints.constrain(size: IVec2) = IVec2(
 ...
 */
@Stable
fun Constraints.isSatisfiedBy(size: IVec2): Boolean {
    return size.x in minWidth..maxWidth && size.y in minHeight..maxHeight
}
